...
export const DEFAULT_MODELS: AIModelOption[] = [
  {
    ...
    isCodeSuited: true,
    isReasoning: true,
    description: 'Intelligently analyzes geometry requirements and auto-routes to the best available free or BYOK model.',
  },
  {
    id: 'gemini-2.5-flash',
    ...
    isCodeSuited: true,
    isFree: true,
    description: 'Fastest Google multi-modal model with high CAD code generation speed and precision.',
  },
  {
    id: 'gemini-2.5-pro',
    name: 'Gemini 2.5 Pro',
    ...
    isReasoning: true,
    isFree: true,
    description: 'Premier Google reasoning model for complex geometric constraints and advanced assemblies.',
  },
  {
    id: 'gemini-2.0-flash',
    ...
    isCodeSuited: true,
    isFree: true,
    description: 'Reliable Google model with strong parametric syntax support.',
  },
  {
    ...
    isCodeSuited: true,
    isReasoning: true,
    description: 'State-of-the-art programming model for exact OpenCASCADE and Replicad script generation.',
  },
  {
    ...
    isCodeSuited: true,
    isReasoning: true,
    description: 'Chain-of-thought open reasoning model for mathematical 3D geometry.',
  },
  {
    ...
    badge: 'Fast Coder',
    isCodeSuited: true,
    description: 'Specialized code generation model with great parametric precision.',
  },
  {
  ...
  },
  {
    ...
    isFree: true,
    isReasoning: true,
    description: 'Free NVIDIA reasoning model for geometric constraint calculations.',
  },
  {
